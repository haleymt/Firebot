...
var Bot = function(options, onSuccess) {
  ...
  this.setUpBot(onSuccess);
};

Bot.prototype = {
  setUpBot: function(onSuccess) {
  ...
  sendMessage: function(text) {
    this.bot.send(this.formatMessage(text));
  },

  sendReply: function(message, channelList, type) {
    this.bot.reply(message, this.formatMessage(channelList, type));
  },
